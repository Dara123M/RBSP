...
def main():
    ...
    for i in range(NUM_INSTANCES):
        ...
        solution, cost = greedy(instances[i][0], instances[i][1], NUM_NODES, fitFiles)
    ...
    writeInCsv(f"{OUTPUT_DIR:s}GREEDY_{NUM_NODES:03}_{int(PROB_EDGES*100):03}.csv", times, solutions, NUM_INSTANCES)
